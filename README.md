...
This PHP attendance system project is primarily concerned with dealing with student's attendance and records. 
...
Note: *Reference for making AcademixHub application are taken from YouTube channel @codecampbdofficial*